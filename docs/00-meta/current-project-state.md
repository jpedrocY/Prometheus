...
```text
Phase 3x merged into main (docs-only Phase 4a safe-slice scoping memo).
Phase 4a safe-slice scope defined; Phase 4a execution remains unauthorized.
...
Future Phase 4a, if ever separately authorized, must be local-only / fake-exchange / dry-run / exchange-write-free / strategy-agnostic.
...
```text
main HEAD:                    dca29af793fc5cb9f66954f7161b65cc9bc915a6
Merge title:                  Merge Phase 3x (docs-only Phase 4a safe-slice scoping memo) into main
Phase 3x memo commit:         14bfb38bab358224402b86831f89b787560157db
Phase 3x closeout commit:     538e8f1680db083705f8a8b7c08c15906bd2e569
Phase 3x merge commit:        dca29af793fc5cb9f66954f7161b65cc9bc915a6
```
