...
- OI / funding capture design (funding history via REST; current
  ...
  context only);
- invalid-window taxonomy (sixteen trigger reasons) with required
  entry fields;
