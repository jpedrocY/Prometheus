...
```text
Phase 4c merged into main (State Package Ruff Residual Cleanup: 2 residual pre-existing Ruff issues in src/prometheus/state/__init__.py and src/prometheus/state/transitions.py:49 fixed via behavior-preserving lint-only edits).
Whole-repo Ruff quality gate fully restored.
...
Phase 4d / any successor phase remains unauthorized.
...
```text
main HEAD:                          4460b2fcbb58407535bdb51fd343eb61d533354e
Merge title:                        Merge Phase 4c (state package ruff residual cleanup) into main
Phase 4c implementation commit:     5ec602207ae49db876b987ce78ecbcecaaa70abc
Phase 4c closeout commit:           52e6127ecb0dbb999cf2307b5d2a173c897bae24
Phase 4c merge commit:              4460b2fcbb58407535bdb51fd343eb61d533354e
```
