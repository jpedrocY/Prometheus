...
```text
Phase 3v merged into main (docs-only GAP-20260424-032 stop-trigger domain ambiguity resolution memo).
GAP-20260424-032 RESOLVED. Stop-trigger-domain governance adopted (§8.4 label scheme).
Historical backtests remain trade_price_backtest provenance; runtime / paper / live remains MARK_PRICE locked.
Future evidence/runtime artifacts must label stop-trigger domain; mixed_or_unknown fails closed.
Remaining OPEN ambiguity-log items: GAP-20260424-030 / 031 / 033.
...
```text
main HEAD:                    15ba71cbc0e0a009a07f8950bf8013eade50cf9f
Merge title:                  Merge Phase 3v (docs-only GAP-20260424-032 stop-trigger domain ambiguity resolution memo) into main
Phase 3v memo commit:         671f6e2f344b3c9734f7dcd5deb3353aac02af57
Phase 3v closeout commit:     5be99783f86eb3830cd9814defda3032073de3c7
Phase 3v merge commit:        15ba71cbc0e0a009a07f8950bf8013eade50cf9f
```
