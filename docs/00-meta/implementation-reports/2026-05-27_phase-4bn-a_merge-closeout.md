...
- **Merge-closeout commit SHA:** `<this file's own commit, `docs(phase-4bn-a): add merge closeout`; recorded in the final operator report and git log, then back-filled here by the SHA-finalization commit>`.
